...
public class ChatRoomAcivity extends AppCompatActivity {
    ListView myList;
    EditText message;
    Button  send, receive;
    ...
    private class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (msg.get(position).isCheck()){
                newView = inflater.inflate(R.layout.activity_message_send, null);
            }else {
                newView = inflater.inflate(R.layout.activity_message_receive, null);
            }
